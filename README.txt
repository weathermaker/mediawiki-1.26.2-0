                    Bitnami MediaWiki Stack 1.26.2-0
                  ==============================
...
MediaWiki is a wiki package originally written for Wikipedia. It is now used 
by several other projects of the non-profit Wikimedia Foundation and by many 
other wikis. MediaWiki was designed to be run on a large server farm for a 
website that gets millions of hits per day. 

You can learn more about Mediawiki at http://mediawiki.org

The Bitnami MediaWiki Stack is an installer that greatly simplifies the
installation of MediaWiki and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. MediaWiki Stack is distributed for free
...
Bitnami MediaWiki Stack ships with the following software:
...
To install Bitnami MediaWiki Stack you will need:
...
The Bitnami MediaWiki Stack is distributed as a binary executable installer.
...
bitnami-mediawiki-1.26.2-0-linux-installer.run on Linux or
bitnami-mediawiki-1.26.2-0-linux-x64-installer.run on Linux 64 bit or
bitnami-mediawiki-1.26.2-0-windows-installer.exe on Windows or
bitnami-mediawiki-1.26.2-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-mediawiki-1.26.2-0-linux.run
...
Email address: Your email address. This will allow MediaWiki to send you
...
The next screen will allow you to configure the Wiki name. This is the title
of your wiki, which will be displayed to visitors.
...
'Installation Finished' page. You can choose to launch Bitnami MediaWiki
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami MediaWiki Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami MediaWiki
Stack in /home/user/mediawiki-1.26.2-0 on Linux or C:\Program Files\Bitnami MediaWiki Stack
on Windows or /Applications/mediawiki-1.26.2-0 and that you use port 
8080 for Apache on Linux and port 80 on Windows and 3306 for MySQL. 

5. STARTING AND STOPPING BITNAMI MEDIAWIKI STACK
...
On Windows, you can start and stop Bitnami MediaWiki Stack on Windows using the shortcuts created
...
http://127.0.0.1:18080/mediawiki/
...
installation directory:
	...
	apps/
	  mediawiki/: MediaWiki application folder
	    conf/: MediaWiki Apache configuration files
	    htdocs/: MediaWiki PHP application files
	  phpMyAdmin/: phpMyAdmin application folder

7. DEFAULT USERNAMES AND PASSWORDS

The MediaWiki administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
MediaWiki administrative user password.
...
This version of the Bitnami MediaWiki stack is a preview version, and as
...
"Cannot open bitnami-mediawiki-1.26.2-0-linux.run: No application suitable for
...
/home/user/mediawiki-1.26.2-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami MediaWiki Stack\apache2\logs\error.log on Windows or
/Applications/mediawiki-1.26.2-0/apache2/logs/error.log on OS X.
...
For any problem related to MediaWiki, please visit 
...
MediaWiki is distributed under the GNU General Public License v2,
which is located at
